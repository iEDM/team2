	...
	var r={
		...
		e.fn[i]=function(n){
			...
			function h(e){
				...
				else{t.arrow.html(o.closedSymbol);
			...
			var l=e("<"+o.parentTag+' aria-haspopup="true" tabindex="0" class="'+s+
			'_btn"><span class="'+s+'_menutxt">'+o.label+'</span><span class="'+a+'"><span class="'+s+
			'_icon-bar"></span><span class="'+s+'_icon-bar"></span><span class="'+s+'_icon-bar"></span></span></a>');
			e(f).append(l);
